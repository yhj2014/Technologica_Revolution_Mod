...
public class NuclearReactorScreen extends AbstractMachineScreen<NuclearReactorContainer> {
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        guiGraphics.drawString(this.font, heatText, 10, 20, 0xFFFFFF);
    }
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        // 渲染能量条
        renderEnergyBar(guiGraphics, leftPos + 10, topPos + 30, menu.getEnergyStored(), menu.getMaxEnergyStored());
        ...
        // 背景
        guiGraphics.fill(leftPos + 30, topPos + 30, leftPos + 30 + heatWidth, topPos + 30 + heatHeight, 0xFF555555);
        ...
        guiGraphics.fill(leftPos + 30, topPos + 30 + heatHeight - heatLevel, leftPos + 30 + heatWidth, topPos + 30 + heatHeight, heatColor);
    }
}